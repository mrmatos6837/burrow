...
- [x] **Phase 13: npm-First Update System** - Replace local git clone update assumptions with npm registry version checks and npx-based updates (completed 2026-03-19)

## Phase Details

### Phase 12: Fix npm Package Files Whitelist
**Goal**: Fix npx create-burrow crash by adding missing burrow.md to package.json files whitelist
**Depends on**: Phase 11
**Requirements**: NPM-02
...
Plans:
- [x] 09-01-PLAN.md — Installer engine: detection, sentinel CLAUDE.md, file operations (TDD)
- [x] 09-02-PLAN.md — Interactive CLI: readline prompts, --yes, --uninstall, integration tests
...
Plans:
- [ ] 13-01-PLAN.md — Rewrite version system for npm registry, update CLI notification, npx-based /burrow:update, remove dead code
