...
Plans:
- [x] 08-01-PLAN.md — Engine tree walk refactors: consolidate counts, optimize moveCard/findParent, deleteCard full return
- [x] 08-02-PLAN.md — Data integrity: schema validation on load, formatAge hardening, makePreview/migrate/addCard optimizations
- [x] 08-03-PLAN.md — Installer: init script for .gitignore and CLAUDE.md setup
- [x] 08-04-PLAN.md — CLI validation, enriched CRUD returns, find rewrite, magic number constants
