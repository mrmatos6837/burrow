...
Use template from `/Users/mrmatos6837/Projects/personal/burrow/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/mrmatos6837/Projects/personal/burrow/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/mrmatos6837/Projects/personal/burrow/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
