...
- **Global scope**: `/Users/mrmatos6837/Projects/personal/burrow/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/mrmatos6837/Projects/personal/burrow/.claude/notes/`)
...
2. Glob `/Users/mrmatos6837/Projects/personal/burrow/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/mrmatos6837/Projects/personal/burrow/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/mrmatos6837/Projects/personal/burrow/.claude/notes/` — works in any directory
