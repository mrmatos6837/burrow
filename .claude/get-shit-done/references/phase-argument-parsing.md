...
```bash
PHASE_INFO=$(node "/Users/mrmatos6837/Projects/personal/burrow/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/Users/mrmatos6837/Projects/personal/burrow/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}" --pick found)
...
```bash
PHASE_DIR=$(node "/Users/mrmatos6837/Projects/personal/burrow/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
